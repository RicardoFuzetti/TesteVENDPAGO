        ...
        <div class="modal">
            ...
            <form action="addEmprestimo_exe.php" method="post">
                ...
                <div class="divSelect">
                    ...
                    $entregaUsuario = date('d/m/Y', strtotime("+7 days", strtotime($hoje)));
                ...
                <div class="divInputs">
                    ...
                    <label>Data de entrega: <?php echo $entregaUsuario ?></label>
                    <?php echo "<input id='inputData' name='dataEntrega' type='hidden' value=' $entrega '>" ?>
                </div>

                <div class="divButtonModal">
                    <button type="button" class="bCancelar" onclick="ModalEmprestimo.close()">Cancelar</button>
                    <button type="submit" class="bCadastrar" onclick="ModalEmprestimo.validarCampo()">Emprestar</button>
                </div>
            </form>
        </div>
    </div>
